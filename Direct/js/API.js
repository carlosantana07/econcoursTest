    ...
    try{
        ...
        if (data.success){ 
            ...
            if(localStorage.getItem("profession")=="Direct")  
                window.location = "https://econcours.gov.bf/Direct/Candidate_Profile/Concours.php";
            else if(localStorage.getItem("profession")=="Professionnel")
                window.location = "https://econcours.gov.bf/pro/Candidate_Profile/Concours.php";
...
postData({ change: true })
  .then(data => {
    ...
    if(document.getElementById("sex").value == "M"){
             ...
             window.location.href = "Profil_Candidat.php";
...
postData({ login: true })
  .then(data => {
    ...
    for (i = 0; i < data.data.length; i++) {
        ...
        seeMore.href = "Concours_Informations.php";
        seeMore.id = i;
        seeMore.type = "reset";
...
function verifierDocument(){
    ...
    saveDocument();
     ...
     window.location.href = "verification_document.php"; // Redirecting to verification page
...
.then(result => {
  ...
  window.location.href = "Candidat_Documents.php"; 
})
.catch(error => {
...
postData({ change: true })
  .then(data => {
    ...
    if(data.code == 405){
        ...
        window.location.href = "Candidat_Concours.php";
...
function loadMinistry(id){
    ...
    window.location.href = "Gouvernement_Information.php";
...
function paySelections(){
    if(document.getElementById('paySelection').value == "OM"){
        ...
        window.location.href = "LoadingOrange.php";
    } else if(document.getElementById('paySelection').value == "MC"){
        
        mobicashVerification();
        
        //localStorage.payCode = document.getElementById('payCode').value;
       //window.location.href = "LoadingMobicash.php";
    }
}
//==========================================================================================================================================
function centerSelection(){
    ...
    if(document.getElementById('compositionCenter').value != ""){
        ...
        window.location.href = "Pay.php"; // Redirecting to concours page
    }else {
...
function applyType(){
    ...
    if((localStorage.getItem("profession") == "Direct"))
            window.location.href = "Center.php"; // Redirecting to concours page
