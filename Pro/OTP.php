                                         ...
                                         <div class="container new-login-area p-otp">
                                            ...
                                            <br>
                                                ...
                                                <div class="modal-dialog modal-member login-label">
                                                    <label for="inputnumber">Votre numéro de téléphone</label>
                                                    <input type="number" class="form-control input-edit" placeholder='Entrez le numéro' id="otptelephone" value="" onchange="validateOTPTelephone()" disabled>
                                                </div>
